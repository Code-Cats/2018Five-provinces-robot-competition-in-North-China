...
void DMA2_Stream2_IRQHandler(void)
{
	if(DMA_GetITStatus(DMA2_Stream2, DMA_IT_TCIF2))
	{
		...
		RC_Ctl.key.v = sbus_rx_buffer[14]; //!< KeyBoard value
	}
}
